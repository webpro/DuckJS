...
"undefined"?function(c,b){module.exports=b()}:function(c,b){this.Future=b()});(function(c){c(["./future"],function(b){var b=b||window.Future,c="MozAppearance"in document.documentElement.style,l="webkitAppearance"in document.documentElement.style,f=function(d,b,a){if(d)if(d.resolve)d.resolve(b,a);else if(typeof d==="function")d.call(null,b);else if(d.innerHTML)d.innerHTML=b.responseText};return{load:function(d){var g=new b,a=["css","content","script"],c,e,f=a.length,k,i,j;for(c=0;c<f;c++)if(e=a[c],i=d[e])if(j="load"+e.charAt(0).toUpperCase()+e.slice(1),typeof i==="string")g.addPromise(this[j].call(this,
